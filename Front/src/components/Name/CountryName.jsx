   ...
   return (
        <div>
            ...
            <div className={styles.countryName}>
                ...
                <Link to={`/detail/${id}`}> {/* Enlace a la página de detalles del país */}
                <img className={styles.countryNameimg} src={flag} alt={`Flag of ${name}`}/> {/* Imagen de la bandera del país con un texto alternativo */}
                </Link>
                <div>
                ...
                : null} {/* Si countryNameButtonClose es falso, no se muestra el componente */}
        </div>
    )
}
