...
function CountryDetail({ country, getCountryId }) {
    ...
    return (
        ...
        <div className={styles.countryCard}>
            ...
            <div>
                <img className={styles.countryCardimg} src={country.flag} alt="Broken flag image" />
            </div>
            ...
            <p>Tourist Activities: {country.activities ? country.activities.map((activity) => "&laquo;" + activity.name + "&raquo; " ) : null}
